    ...
    return {
        ...
        link: function(scope, element, attrs) {
            element.bind("click", function() {
                if($rootScope.isMinimizedMenu == 0 || $rootScope.isMinimizedMenu == null){
                    $rootScope.isMinimizedMenu = 1;
                }else
                {
                    $rootScope.isMinimizedMenu = 0;
                }
                Lockr.set("isMinimizedMenu", $rootScope.isMinimizedMenu);
                scope.$apply();
            });
        }
    }
